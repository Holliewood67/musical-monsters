                        ...
                        <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
                            ...
                            <nav className="hidden md:flex p-4 w-full ">
                                <ul className="flex w-full justify-around lg:justify-normal gap-6 lg:gap-10">
                                    ...
                                    <li className="my-2 py-2 "><a href={"https://vt.tiktok.com/ZTYFNmH3s/?page=TikTokShop"} target="_blank" className="text-yellow-400 hover:text-gray-700">Shop</a></li>
                ...
                <div className={` ${!open && "hidden"} p-4 w-full border-b-2 border-yellow-400`} id="navbar-default">
                    <nav>
                        <ul>
                            ...
                            {/* <li className="my-2 py-2 border-b-2 border-yellow-600"><a href={"https://www.musicalmonstersshop.com"} target="_blank" className="text-yellow-400 hover:text-gray-700">Shop {">"}</a></li> */}
                            <li className="my-2 py-2 "><a href={"https://vt.tiktok.com/ZTYFNmH3s/?page=TikTokShop"} target="_blank" className="text-yellow-400 hover:text-gray-700">Shop</a></li>
